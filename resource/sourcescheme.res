...
Scheme
{
	...
	Colors
	{
		...
		"NotoGreen"				"156 194 151 255"
		"NotoDark"				"99 122 91 255"
	...
	Fonts
	{
		"DefaultFixedOutline" //edited by INsane 2010 for small netgraph font on all screen sizes
		{
            ...
            {
                "name"         "HelveticaNeue-Extended" [$WINDOWS] // Standard is "HelveticaNeue-Extended" Options are "Microsoft Sans Serif" "HelveticaNeue-Extended" "Impact" "HelveticaNeue-Extended MT" and the best for small = "Haettenschweiler" but is a MS office and Win7 font, can be downloaded, google "Haettenschweiler" and install in C:/Windows/Fonts
                "name"         "HelveticaNeue-Extended" [$X360]    //"HelveticaNeue-Extended"
                "name"         "HelveticaNeue-Extended" [$POSIX] // Apple Mac OS "HelveticaNeue-Extended" (default) Best small font = "HelveticaNeue-Extended" Mac Installation location: /Library/Fonts and is default on Mac OS
                "tall"         "11" [$POSIX]  // "11"
                "tall"         "10" //good positioning is ... "net_graphpos 183" and "net_graphheight 30" and ensure you select "antialias"  "1" with all others off with "HelveticaNeue-Extended" font.
                "tall_lodef" "15" //"15"
                "tall_hidef" "20" //"20" 
            ...
            "2" //For screen heights between 600 and 767 (eg 4:3 aspect Width 800X600 High, ... 16:9 aspect Width 1152x648 High.)
            {
                ...
                "name"         "HelveticaNeue-Extended" [$POSIX] // Apple Mac OS "HelveticaNeue-Extended" (default) Best small font = "HelveticaNeue-Extended" Mac Installation location: /Library/Fonts and is default on Mac OS
                "tall"         "12" [$POSIX]  // "11"                
                "tall"         "12" //good positioning is ... "net_graphpos 190" and "net_graphheight 45" and ensure you select "antialias"  "1" with all others off with "HelveticaNeue-Extended" font.
                "tall_lodef" "15" //"15"
                "tall_hidef" "20" //"20"                
                "weight"     "0"
                "range"         "0x0000 0x017F" //    Basic Latin, Latin-1 Supplement, Latin Extended-A
            ...
            "5" //For screen heights between 1200 and 6000 (6000...wow that's freaking huge!) (eg 4:3 aspect Width 1600X1200 High... 16:10 aspect Width 1920x1200 High.... and beyond) 
            {
                "name"         "HelveticaNeue-Extended" [$WINDOWS] // Standard is "HelveticaNeue-Extended" Options are "Microsoft Sans Serif" "HelveticaNeue-Extended" "Impact" "HelveticaNeue-Extended MT" and the best for small = "Haettenschweiler" but is a MS office and Win7 font, can be downloaded, google "Haettenschweiler" and install in C:/Windows/Fonts
                "name"         "HelveticaNeue-Extended" [$X360]    //"HelveticaNeue-Extended"
                "name"         "HelveticaNeue-Extended" [$POSIX] // Apple Mac OS "HelveticaNeue-Extended" (default) Best small font = "HelveticaNeue-Extended" and "HelveticaNeue-Extended" Mac Installation location: /Library/Fonts and is default on Mac OS
                "tall"         "19" [$POSIX]  // "11"                
		...
		AchievementItemDescription	[$WIN32]
		{
			"1"
			{
				"name"		"HelveticaNeue-Extended" [!$OSX]
				"name"		"HelveticaNeue-Extended" [$OSX]
				"weight"		"1000"
				"tall"			"14" [!$OSX]
				"tall"			"12" [$OSX]
